...
function loadLists() {
    if (!isPermalink) {
        ...
        getTemplateAjax('templates/current.hbars.html', function(tmpl) {
            loadYAML("current", function(yaml) {
                yaml.sort(function(a,b) {
                    return a.author.localeCompare(b.author);
                });
                $("#current").html(tmpl(yaml));
                $("#current-count").append(yaml.length);
    ...
    getTemplateAjax('templates/finished.hbars.html', function(tmpl) {
        loadYAML("finished", function(yamlUnfiltered) {
            ...
            yamlUnfiltered.sort(function(a,b) {
                return a.author.localeCompare(b.author);
            });
